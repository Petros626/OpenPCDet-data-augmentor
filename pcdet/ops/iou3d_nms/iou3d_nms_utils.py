...
def boxes_iou3d_gpu(boxes_a, boxes_b):
    ...
    # Replace deprecated usage with torch.zeros and specify device='cuda'
    # overlaps_bev = torch.zeros((boxes_a.shape[0], boxes_b.shape[0]), dtype=torch.float32, device='cuda')
