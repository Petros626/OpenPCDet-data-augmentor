...
from ..kitti import kitti_object_eval_python
...
class CustomDataset(DatasetTemplate):
    ...
    def __getitem__(self, index):
        ...
        data_dict = self.prepare_data_bev(data_dict=input_dict)
...
def create_custom_infos(dataset_cfg, class_names, data_path, save_path, workers=4):
    dataset = CustomDataset(dataset_cfg=dataset_cfg, class_names=class_names, root_path=data_path, training=True, logger=common_utils.create_logger())
    ...
    #custom_infos_train = []
    #for index in range(num_samples_train):
    #    data_dict = dataset.__getitem__(index)
    #    custom_infos_train.append(data_dict)
